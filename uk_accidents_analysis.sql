...
SELECT Month_name ,COUNT(Accident_Index) FROM accidents.accidents_2015
GROUP BY Month_name;
...
SELECT Road_Surface_Conditions, COUNT(Accident_Index) FROM accidents.accidents_2015
...
SELECT Weather_Conditions, COUNT(Accident_Index) FROM accidents.accidents_2015
...
SELECT Speed_limit, COUNT(Accident_Index) FROM accidents.accidents_2015
